...
To avoid the app from having to deal with the implementation details of the web worker, the `App` function receives an instance of the SDK that acts as the communication channel between the app and the store.
